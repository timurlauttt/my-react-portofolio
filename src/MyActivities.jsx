        ...
        <>
            <section id="activities" className="mt-8 w-full h-full text-black border-2 border-black" style={{ backgroundImage: 'url(d.png)' }}>
                <div className="container mx-auto text-center">
                    ...
                    <p className="font-normal mt-2 mb-2 p-2 text-left sm:text-center text-md md:text-lg">Here are some of the activities I've participated during my study, you can click on the cards to find out more!</p>
