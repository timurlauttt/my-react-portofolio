...
function Footer() {
    ...
    return (
        <>
            <footer className="footer bg-[#0a0a0a] dark:bg-black text-white py-6 px-4 sm:py-8 sm:px-10 md:px-40">
                    ...
                    <div className="block sm:hidden space-y-6">
                            ...
                            <div className="space-y-3">
                                <div>
                                    <a href="mailto:2211103102@ittelkom-pwt.ac.id"
                                        className="flex items-center gap-2 text-sm hover:text-[#38BDF8] transition-colors">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm">
                                ...
                                <a href="#skills" className="hover:text-[#38BDF8] transition-colors">{t('skills')}</a>
                                <a href="#activities" className="hover:text-[#38BDF8] transition-colors">{t('activities')}</a>
                                <a href="#contact" className="hover:text-[#38BDF8] transition-colors">{t('contact')}</a>
                                <a href="#about" className="hover:text-[#38BDF8] transition-colors">{t('about')}</a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-6 text-sm">
                                ...
                                <div className="flex items-center gap-2">
                                    <a href="https://www.tiktok.com/@pangestuurip?_t=ZS-8ykixitNw0r&_r=1" target="_blank" rel="noopener noreferrer" className="hover:text-[#38BDF8] transition-colors">
                    ...
                    <div className="hidden sm:grid grid-cols-1 md:grid-cols-5 gap-6 text-center md:text-left">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="#skills" className="hover:text-[#38BDF8] transition-colors">{t('skills')}</a></li>
                                <li><a href="#activities" className="hover:text-[#38BDF8] transition-colors">{t('activities')}</a></li>
                                <li><a href="#contact" className="hover:text-[#38BDF8] transition-colors">{t('contact')}</a></li>
                                <li><a href="#about" className="hover:text-[#38BDF8] transition-colors">{t('aboutMe')}</a></li>
                            </ul>
                        </div>
            ...
            {/* Footer Bottom */}
            <div className="h-auto flex flex-col items-center justify-center bg-white text-black py-3">
